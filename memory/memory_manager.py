...
def should_extract_memory(user_text: str, brahma_text: str, api_key: str = "") -> bool:
    try:
        ...
        combined = f"User: {user_text[:300]}\nUltron Jarvis: {brahma_text[:1000]}"
...
def extract_memory(user_text: str, brahma_text: str, api_key: str = "") -> dict:
    try:
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building an Ultron Jarvis assistant')\n"
            ...
            f"- Extract from BOTH user and Ultron Jarvis turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"Ultron Jarvis assistant"}}}},\n'
