...
class DiscordBotService:
    ...
    async def _send_channel_message(self, channel, role: str, text: str):
        ...
        if isinstance(channel, int):
            try:
                ...
                return
        prefix = "Ultron Jarvis" if role == "assistant" else "You" if role == "user" else "System"
            ...
            async def on_message(message):
                ...
                if self._app_submitter is not None:
                    ...
                    try:
                        ...
                        await message.reply(
                            "I couldn’t hand that command to Ultron Jarvis.",
    ...
    def _generate_reply(self, prompt: str) -> str:
        ...
        system_prompt = (
            "You are Ultron Jarvis inside Discord. "
